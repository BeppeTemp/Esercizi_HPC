...
int main(int argc, char const* argv[]) {
    ...
    __m256 f256_vec_0 = _mm256_set_ps(1, 2, 3, 4, 5, 6, 7, 8);
    __m256 f256_vec_1 = _mm256_set_ps(9, 10, 11, 12, 13, 14, 15, 16);

    __m256 f256_result = _mm256_shuffle_ps(f256_vec_0, f256_vec_1, 0b00010111);

    float* flo = (float*)&f256_result;

    printf("float:\t\t%f, %f, %f, %f, %f, %f, %f, %f\n", flo[0], flo[1], flo[2], flo[3], flo[4], flo[5], flo[6], flo[7]);  // Double-precision shuffle
    ...
    printf("int:\t\t%d, %d, %d, %d, %d, %d, %d, %d\n", i[0], i[1], i[2], i[3], i[4], i[5], i[6], i[7]);  // 8-bit integer shuffle
